...
public class DecimalHexBinaryConverter {
	 ...
	 public static String decimalToHexa(Integer decimalNumber) {
	    ...
	    public static String decimalToBinary(Integer decimalNumber) {
	        ...
	        int counter = 0;
	        // retira do último índice de caracteres
	        for (int i=binary.length-1; i>=0; i--) {
	            counter++;
	            sbBinary.append(binary[i]);
	            // redefina o contador para zero se tiver conseguido obter caracteres de 4 dígitos
	            if (counter == 4) counter = 0;
	        }
	 
	        // 4 é o comprimento de caractere de cada bloco no binário
